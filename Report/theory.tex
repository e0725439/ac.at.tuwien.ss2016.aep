...
\begin{itemize}
	...
	When basic assumptions are made on complete information, than players will create a Nash Equlibrium, otherwise it will be a one-shot game.
...
The bidding behaviour of one provider indicated the interest rate for the frequency. 
