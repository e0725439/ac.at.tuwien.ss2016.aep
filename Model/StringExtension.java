...
public class StringExtension extends DefaultClassManager
{
	...
	pM.addPrimitive ( "split-string", 		new SplitString () ) ;
	pM.addPrimitive ( "split-int", 			new SplitInt() ) ;
	pM.addPrimitive ( "list-diff", 			new ListDiff() ) ;
	pM.addPrimitive ( "list-rank",			new ListRank() ) ;
    }
}
